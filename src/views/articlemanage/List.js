...
export default class List extends Component {
    state = {
        ...
        columns:[
            ...
            },
            {
                ...
                key: 'x',
                render: (item) => <div>
                    <Button  shape="circle" icon={<ChromeOutlined />} onClick={()=>this.handlePreviewClick(item.id)}/>
                    &nbsp;
                    <Button type="primary" shape="circle" icon={<EditOutlined />} onClick={()=>this.handleUpdateClick(item.id)}/>
                    &nbsp;
                    <Button type="danger" shape="circle" icon={<DeleteOutlined />}
                    onClick={()=>this.handleDelClick(item.id)}></Button>
                </div>,
            }
        ]
    }
    ...
    render() {
        return (
            <div>
              <Button onClick={this.changePage} type="primary">添加文章</Button>
